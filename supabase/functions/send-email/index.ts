...
Deno.serve(async (req) => {
  ...
  const html =
    ...
    `<style>@import url('https://fonts.googleapis.com/css2?family=Manrope:wght@600;700;800&family=Inter:wght@400;500;600&display=swap');` +
    `body{margin:0;padding:0;background:#eef0f3;}img{border:0;line-height:100%;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;}a{text-decoration:none;}` +
    ...
    `@media only screen and (max-width:620px){.card{border-radius:0!important}.pad{padding-left:24px!important;padding-right:24px!important}.pad-y{padding-top:30px!important;padding-bottom:30px!important}.head{padding-top:30px!important;padding-bottom:30px!important}.logo{height:40px!important}.h1{font-size:21px!important}.outer{padding:0!important}}</style></head><body>` +
    ...
    `<tr><td class="pad head" align="center" style="background:#141414;background-image:linear-gradient(180deg,#1c1c1c 0%,#111111 100%);border-bottom:4px solid #C8102E;padding:38px 34px;text-align:center;"><img src="${LOGO}" alt="CNT Promo &amp; Ads Specialists, Inc." height="52" class="logo" style="height:52px;width:auto;display:inline-block;"><div style="color:#9a9a9a;font-size:11px;font-weight:600;letter-spacing:.22em;margin-top:16px;text-transform:uppercase;">Employment &amp; Manpower Services</div></td></tr>` +
    `<tr><td class="pad pad-y" style="padding:40px;color:#3f3f46;font-size:15px;line-height:1.7;"><span style="display:inline-block;background:#FDE7EA;color:#C8102E;font-size:10.5px;font-weight:700;letter-spacing:.13em;text-transform:uppercase;padding:6px 13px;border-radius:100px;">CNT Recruitment</span><h1 class="h1" style="font-family:'Manrope','Inter',-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;font-size:26px;font-weight:800;color:#171717;letter-spacing:-.02em;line-height:1.2;margin:18px 0 16px;">${esc(subject)}</h1>${paras}</td></tr>` +
    `<tr><td class="pad" style="background:#fafafa;border-top:1px solid #ededed;padding:30px 34px;text-align:center;"><img src="${LOGO}" alt="CNT" height="22" style="height:22px;width:auto;display:inline-block;opacity:.35;filter:grayscale(100%);margin-bottom:14px;"><div style="font-size:12px;color:#8a8a8a;line-height:1.7;">This is an automated message from <b style="color:#555;">CNT Promo &amp; Ads Specialists, Inc.</b><br>Please do not reply to this email.</div><div style="margin-top:14px;font-size:11.5px;color:#aeaeae;line-height:1.7;">219 LYFE Tower, Shaw Blvd., Mandaluyong City<br><a href="mailto:hrdadmin@cntpromoads.com" style="color:#C8102E;text-decoration:none;">hrdadmin@cntpromoads.com</a> &nbsp;&middot;&nbsp; <a href="${SITE}" style="color:#C8102E;text-decoration:none;">Visit our website</a></div><div style="margin-top:18px;padding-top:16px;border-top:1px solid #ededed;font-size:11px;color:#bdbdbd;">&copy; ${YEAR} CNT Promo &amp; Ads Specialists, Inc. All Rights Reserved.</div></td></tr>` +
    `</table>` +
