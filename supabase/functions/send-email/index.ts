...
Deno.serve(async (req) => {
  ...
  const html =
    ...
    `<tr><td class="pad head" align="center" style="background:#141414;background-image:linear-gradient(180deg,#1c1c1c 0%,#111111 100%);border-bottom:4px solid #C8102E;padding:38px 34px;text-align:center;"><img src="${LOGO}" alt="CNT Promo &amp; Ads Specialists, Inc." height="52" class="logo" style="height:52px;width:auto;display:inline-block;"><div style="color:#cfcfcf;font-size:12px;font-weight:700;letter-spacing:.12em;margin-top:15px;text-transform:uppercase;">A Million Jobs for a Million Filipinos.</div></td></tr>` +
